                                ...
                                <div className='bg-[#FFD100] rounded-[20px] py-[30px] md:py-[30px] px-[25px] mr-auto h-full'>
                                    {sections[activeTab].map((item, index) => (
                                        <div key={index}>
                                            ...
                                            <Link href="tel:012-345-6789" className='bg-black text-white text-[13px] md:text-[17px] leading-[25px] montserrat rounded-[7px] block sm:w-max py-[10px] px-[35px]'>Get A Call For Free Consultation</Link>
                                        </div>
                                    ))}
                                </div>
                            )}
