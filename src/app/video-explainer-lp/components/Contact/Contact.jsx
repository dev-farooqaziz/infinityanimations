                                ...
                                <ul>
                                    ...
                                    <li className='py-[10px]'>
                                        <a href="javascript:;" target='_blank' className='text-[15px] md:text-[20px] text-white montserrat flex gap-2'>
                                            <HiMapPin className='bg-[#fc0] text-[#222] rounded-[60%] p-[4px] text-[15px] w-[40px] md:w-[45px] h-[25px]' /> Office abc street, New York
                                        </a>
                                    </li>
                                    <li className='py-[10px]'>
                                        <a href="javascript:;" target='_blank' className='text-[15px] md:text-[20px] text-white montserrat flex gap-2'>
                                            <HiMapPin className='bg-[#fc0] text-[#222] rounded-[60%] p-[4px] text-[15px] w-[25px] h-[25px]' /> Office abc street, Canada
                                        </a>
                                    </li>
                                </ul>
