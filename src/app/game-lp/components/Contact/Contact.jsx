                            ...
                            <div className="txt">
                                ...
                                <div className="details">
                                    <div className="flex flex-wrap items-center justify-between pr-14 5xl:w-[75%]">
                                        ...
                                        <Link href="mailto:info@xyz.com" className="flex items-center justify-center gap-4  mb-4 lg:mb-8">
                                            <Image src={Email} alt='Email' />
                                            <span className='text-[14px] xl:text-[17px] leading-[24px] xl:leading-[27px] font-normal poppins'>info@xyz.com</span>
                                        </Link>
                                    </div>
                                    <Link href="mailto:info@xyz.com" className="flex items-center gap-4 mb-4 lg:mb-7">
