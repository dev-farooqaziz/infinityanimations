                ...
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto">
                    <div className="grid grid-cols-12 gap-6">
                        <div className="col-span-12">
                            <h2 className='text-[#231f20] text-center font-[700] montserrat text-[20px] md:text-[25px] lg:text-[30px]'>Types of Animated Explainer Videos</h2>
                            <p className='text-[#231f20] text-[16px] lg:text-[18px] montserrat font-[400] py-[17px] text-center lg:w-10/12 mx-auto leading-[22px] pb-[20px] sm:pb-[40px] md:pb-[70px]'>Infinity Animations, a leading Video Animation Company, excels in Video Animation Production using the latest technology and techniques. Discover the diverse range of captivating animation styles we offer below.</p>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-12 gap-6">
                            <div className="col-span-12 md:col-span-6 lg:col-span-4">
                                <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                    ...
                                    <div className="content">
                                        <h2 className='text-black text-[20px] md:text-[25px] font-bold montserrat pt-[20px] pb-[10px] leading-[23px] md:leading-[33px] lg:h-[96px]'>Whiteboard Animation Videos</h2>
                            ...
                            <div className="col-span-12 md:col-span-6 lg:col-span-4">
                                <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                    ...
                                    <div className="content">
                                        <h2 className='text-black text-[20px] md:text-[25px] font-bold montserrat pt-[20px] pb-[10px] leading-[23px] md:leading-[33px] lg:h-[96px]'>Motion Graphics Videos</h2>
                            ...
                            <div className="col-span-12 md:col-span-6 lg:col-span-4">
                                <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                    ...
                                    <div className="content">
                                        <h2 className='text-black text-[20px] md:text-[25px] font-bold montserrat pt-[20px] pb-[10px] leading-[23px] md:leading-[33px] lg:h-[96px]'>2D Character Animation Videos</h2>
                            ...
                            <div className="col-span-12 md:col-span-6 lg:col-span-4">
                                <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                    ...
                                    <div className="content">
                                        <h2 className='text-black text-[20px] md:text-[25px] font-bold montserrat pt-[20px] pb-[10px] leading-[23px] md:leading-[33px] lg:h-[96px]'>3D Animation Videos</h2>
                            ...
                            <div className="col-span-12 md:col-span-6 lg:col-span-4">
                                <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                    ...
                                    <div className="content">
                                        <h2 className='text-black text-[20px] md:text-[25px] font-bold montserrat pt-[20px] pb-[10px] leading-[23px] md:leading-[33px] lg:h-[96px]'>Screencast Animation Videos</h2>
                            ...
                            <div className="col-span-12 md:col-span-6 lg:col-span-4">
                                <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                    ...
                                    <div className="content">
                                        <h2 className='text-black text-[20px] md:text-[25px] font-bold montserrat pt-[20px] pb-[10px] leading-[23px] md:leading-[33px] lg:h-[96px]'>Typography Animation Videos</h2>
