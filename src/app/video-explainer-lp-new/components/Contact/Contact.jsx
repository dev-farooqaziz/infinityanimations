                                ...
                                <ul>
                                    <li className='py-[10px]'>
                                        <a href="tel:012-345-6789" className='text-[16px] text-white montserrat flex items-center gap-2'>
                                            <Phone className='bg-[#fc0] text-[#000] rounded-[60%] p-[4px] text-[15px] w-[26px] h-[26px]' /> 012-345-6789
                                        </a>
                                    </li>
                                    <li className='py-[10px]'>
                                        <a href="mailto:info@xyz.com" className='text-[16px] text-white montserrat flex items-center gap-2'>
                                            <EnvelopeIcon className='bg-[#fc0] text-[#000] rounded-[60%] p-[4px] text-[15px] w-[26px] h-[26px]' /> info@xyz.com
                                        </a>
                                    </li>
                                    <li className='py-[10px]'>
                                        <a href="javascript:;" className='text-[16px] text-white montserrat flex items-center gap-2'>
                                            <Globe className='bg-[#fc0] text-[#000] rounded-[60%] p-[4px] text-[15px] w-[26px] h-[26px]' /> infinityanimations
                                        </a>
                                    </li>
                                </ul>
