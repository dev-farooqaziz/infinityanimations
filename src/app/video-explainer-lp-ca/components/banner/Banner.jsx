                    ...
                    <div className="grid grid-cols-12 gap-y-12 items-center">
                        <div className="col-span-12 lg:col-span-6">
                            ...
                            <div className="flex gap-4 md:gap-2">
                                <div className="btn">
                                    <a href='tel:012-345-6789' className='flex items-center text-[14px] lg:text-[16px] text-black font-[700] montserrat bg-[#f6c501] py-[12px] px-[20px] md:px-[35px] tracking-[.3px] rounded-[5px] leading-[20px] shadow-2xl'>
                                        Call Now
                                    </a>
                                </div>
