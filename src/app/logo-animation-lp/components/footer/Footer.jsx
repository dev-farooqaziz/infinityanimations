                    ...
                    <div className="grid grid-cols-1">
                        ...
                        <div className="flex flex-wrap items-center justify-center sm:justify-between gap-2 sm:gap-5 lg:w-9/12 mx-auto pt-8">
                            <div className="number">
                                <Link href="tel:012-345-6789" className='text-[#272b2b] font-[600] text-[14px] sm:text-[16px] poppins flex items-center gap-x-2'>
                                    <FaPhoneAlt className='text-[#9545cc] text-[18px] sm:block hidden' />
                                    <span>012-345-6789</span>
                                </Link>
                            </div>
                            <div className="email">
                                <Link href="mailto:info@xyz.com" className='text-[#272b2b] font-[600] text-[14px] sm:text-[16px] poppins flex items-center gap-x-2'>
